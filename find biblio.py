...
def find_biblio(path):
    document = Document(path) #изменить путь в передаваемую переменную
...
filePath = "/home/danila/Downloads/pz2(Изменил пункт 10).docx"
l = find_biblio(filePath) 
for i in l:
    print(i)